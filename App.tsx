                ...
                <div className="flex-1 w-full pb-24 md:pb-0">
                    {currentView === 'pos' ? (
                      <div className="flex flex-col md:flex-row h-full">
                        ...
                        <div className={`fixed inset-y-0 right-0 z-50 w-full md:fixed md:w-[450px] md:border-l md:border-gray-200 md:bg-white shadow-2xl md:shadow-none transform transition-transform duration-300 ease-in-out ${isMobileCartOpen ? 'translate-x-0' : 'translate-x-full md:translate-x-0'}`}>
                          <CartSidebar 
                            cart={cart} 
                            users={users} 
                        ...
                        <div className="hidden md:block w-[450px] flex-shrink-0"></div>
                      </div>
                    ) : (
